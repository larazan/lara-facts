        ...
        <div class="sm:px-6 lg:px-0 lg:col-span-9">
                ...
                <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                    ...
                    <div class="container max-w-screen-lg mx-auto cl border-slate-200">
                        <div>
                            <h2 class="gu tef text-slate-800 font-bold">Create Fact</h2>
                            ...
                            <div class="bg-white rounded2 shadow-lg2 p-4 px-4 md:p-8 mb-6">
                                <div class="flex w-full text-sm grid-cols-1 space-x-3">
                                    ...
                                    <div class="w-3/4 lg:col-span-2">
                                        <form wire:submit.prevent="createFact">
                                            <div class="flex flex-col space-y-4">
                                                ...
                                                <div class="col-start-1 sm:col-span-3">
                                                    ...
                                                    <div class="@if($factId == null){{ 'block' }}@else{{ 'hidden' }}@endif mt-2 bg-white border border-gray-200" wire:ignore>
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    ...
                                                    <select wire:model="factStatus" class="h-full rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none">
                                                ...
                                                <div class="md:col-span-5 text-right">
                                                    <div class="inline-flex items-end space-x-2">
                                                        <a href="{{ url('admin/fact/all') }}" class="btn border-slate-200 hover--border-slate-300 text-indigo-500">Back</a>
                                                        <button type="button" wire:click="createFact" class="btn ho xi ye">Submit</button>
                                                    </div>
                                                </div>

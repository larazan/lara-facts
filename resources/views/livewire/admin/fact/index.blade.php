<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Fact</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <form class="y">
                ...
                <button class="g w j kk" type="submit" aria-fact="Search">
            ...
            <a href="{{ url('admin/fact/create') }}" class="btn ho xi ye">
                <svg class="oo sl du bf ub" viewBox="0 0 16 16">
                    <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z"></path>
                </svg>
                <span class="hidden trm nq">Create Fact</span>
            </a>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Facts <span class="gq gp"></span></h2>
        </header>
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{!! nl2br(General::smart_wordwrap($fact->title, 40)) !!}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                @if($fact->small)
                                <div class="gp ">
                                    <img src="{{ asset('storage/'.$fact->small) }}" class="object-scale-down h-48 w-96" alt="{{ $fact->title }}">
                                </div>
                                @endif
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $fact->category($fact->category_id) }}</div>
                            </td>
                            
                            <td class="vi wy w_ vo lm">
                                <div class="gp capitalize">{{ Str::words($fact->description, 5) }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                            ...
                            <td class="vi wy w_ vo lm">
                                <div>{{ $fact->created_at->format('d-m-Y') }}</div>
                            </td>

                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button wire:click="gotoEdit('{{ $fact->id }}')" class="gq xv rounded-full" >
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $fact->id }})">

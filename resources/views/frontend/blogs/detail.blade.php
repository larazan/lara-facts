...
<div class="flex flex-col bg-white min-h-screen pt-14 md:pt-[60px]">
  ...
  <header class="max-w-[800px] flex flex-col gap-6 p-6 relative z-10 mt-16"><h1 class="__className_d306d5 font-extrabold text-4xl text-center " style="text-wrap: balance;">Top Tricks for Google Sheets You Might Not Know About</h1><h4 class=" flex flex-col sm:flex-row items-center text-center gap-3 sm:gap-1 w-full justify-center "><img src="https://smmall-cdn.online/levi/avatar/b87526c6fd6e4db3d80eff954facce1a.png" alt="Author image" class="rounded-full border mr-3" width="40" height="40"><span class="flex sm:flex-row flex-col items-center sm:gap-1">Published on 1 Jul 2023&nbsp;by <span class="font-bold"><p><a href="https://levi.smmall.cloud">Levi</a></p>
    </span></span></h4></header>

    <article class="prose max-w-full sm:max-w-[740px] px-6"><p>So, you've been diving into Google Sheets, trying to wrangle data and make it work for you. Well, guess what? There are some pretty nifty tricks hiding under the hood that can seriously level up your Sheets game. Check these out:</p>
...
<p>And there you have it! These sneaky Google Sheets tricks will seriously up your spreadsheet game. Go ahead, give them a spin! 🚀✨</p></article>
  <!--  -->
